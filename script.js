let prompts = [
  "You're directing a trainee on your team to double-check measurements on a site plan where concrete will be poured. The trainee should write all missing dimensions directly on the diagram and circle any measurements that should be verified before construction begins.",
  ...
  "You're teaching a new technician to read a hydraulic system diagram. The trainee should label the pumps, valves, cylinders, and hoses and trace the direction of fluid flow.",
  ...
  "You're reviewing a printed circuit board layout. The trainee should identify major electronic components and draw arrows showing the likely path of electrical signals.",
